...
<div id="wrapper">
 ...
 <h1 class="header_course">Въведение в Java</h1>

    <div class="video_main">

            
		<iframe class="video_course"  src="//www.youtube.com/embed/v7lUQoOsVb8" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="comments">
		...
		<input type="hidden" name="action" value="commentj" />
...
<sql:query dataSource="${ds}" sql="select * from commentj  limit 100" var="results" />
