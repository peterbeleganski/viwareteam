...
<div id="wrapper">
 ...
 <h1 class="header_course">Програмиране на мобилни приложения с Android</h1>

    <div class="video_main">

     <iframe  class="video_course" src="//www.youtube.com/embed/T3K_r0gr9WY" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="comments">
		...
		<input type="hidden" name="action" value="commentAND" />
...
<sql:query dataSource="${ds}" sql="select * from commenta " var="results" />
