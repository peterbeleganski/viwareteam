...
<div id="wrapper">
 ...
 <h1 class="header_course">Програмиране на Динамични приложения с JSP & SERVLET</h1>

    <div class="video_main">

			<iframe   class="video_course" src="//www.youtube.com/embed/zdJ0p8XIxXk" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="comments">
		...
		<input type="hidden" name="action" value="commentjsp" />
...
<sql:query dataSource="${ds}" sql="select * from commentjsp  " var="results" />
