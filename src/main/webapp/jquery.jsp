...
<div id="wrapper">
 ...
 <h1 class="header_course">Въведение в jQuery</h1>

    <div class="video_main">

       
            
			<iframe class="video_course" src="//www.youtube.com/embed/FG2O6GRAHXM" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="comments">
		...
		<input type="hidden" name="action" value="commentjq" />
...
<sql:query dataSource="${ds}" sql="select * from commentjq  " var="results" />
